  ...
  return (
    <div className='hero-section pt-10'>
      <div className="section-one">
        ...
        <h2 className='text-6xl bg-linear-to-r from-[#D81B7E] via-[#7C3AED] to-[#FF5722] bg-clip-text text-transparent inline-block font-extrabold leading-14 tracking-[-1.5px]' >Development Stack</h2>
        <p className ="text-[18px] font-normal text-[#475569] mt-6 mb-16">Explore frontend, backend, database, and tooling options,
